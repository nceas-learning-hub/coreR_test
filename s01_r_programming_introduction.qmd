...
<!-- [Full Screen](slides/example_slides.html) -->

```{=html}
<iframe class="slide-deck" src="slides/example_slides.html" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
